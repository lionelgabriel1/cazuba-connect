...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Capacitando talentos, construindo futuros. Cursos profissionais de Informática, Inglês, Marketing Digital, Contabilidade e mais no Município do Hoje-ya-Henda." },
